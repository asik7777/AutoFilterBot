...
BOT_TOKEN = environ.get('BOT_TOKEN', '6080595748:AAGROd0knAtRdXVQWqAfLWh4Z-2rjeXH958')
...
PICS = (environ.get('PICS', 'https://graph.org/file/2d7957261f5580db933bf.jpg')).split()

# Bot Admins
ADMINS = [int(admins) if id_pattern.search(admins) else admins for admins in environ.get('ADMINS', '-1001840403231').split()]
...
# Channels
INDEX_CHANNELS = [int(index_channels) if id_pattern.search(index_channels) else index_channels for index_channels in environ.get('INDEX_CHANNELS', '-1001840403231').split()]
auth_channel = environ.get('AUTH_CHANNEL', '')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001909584211'))

# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://Tousif2001:Tousif2001@cluster0.spoceyi.mongodb.net/?retryWrites=true&w=majority")
